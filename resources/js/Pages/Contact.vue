            ...
            <div class="p-8 sm:p-10">
              ...
              <form @submit.prevent="contactForm">
                ...
                <div class="mb-5">
                  ...
                  <input type="email" placeholder="example@youmail.com"
                    class="w-full p-5 text-gray-800 transition-all duration-300 border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                    v-model="form.email">
                </div>
                <div class="mb-5">
                ...
                <div class="mb-6">
                  ...
                  <textarea placeholder="Type here..." rows="5"
                    class="w-full p-5 text-gray-800 transition-all duration-300 border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent resize-none"
                    v-model="form.message"></textarea>
                </div>
                <button type="submit"
                  class="w-full py-5 text-lg font-medium text-white transition-all duration-300 transform rounded-lg shadow-md bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 hover:shadow-lg hover:-translate-y-1">
                  Send Now
                </button>
              </form>
            </div>
