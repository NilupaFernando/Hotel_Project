          ...
          <div class="lg:w-64">
            ...
            >
              ...
              <div class="mb-6">
                ...
                <select v-model="selectedProvince" @change="filterProvinces" class="w-full p-2 border rounded-md focus:ring-orange-300 focus:border-orange-300">
              ...
              <div class="mb-6">
                ...
                <div class="space-y-2">
                  <div v-for="type in accommodationTypes" :key="type" class="flex items-center">
                    <input
                      type="checkbox"
                      @change="filterByAccommodationType"
                      :id="type"
          ...
          <div class="flex-1">
            ...
            <div class="flex flex-col sm:flex-row mb-6 justify-between gap-4">
              ...
              <select
                ...
                class="p-2 border border-orange-300 rounded-md focus:ring-orange-300 focus:border-orange-300 w-full sm:w-60"
              >
...
.input {
  ...
  background: white;
  color: #202020; /* Orange text color */
  font-size: 16px;
...
input:focus {
  ...
  box-shadow: 0px 0px 15px rgba(230, 92, 0, 0.7);
}
